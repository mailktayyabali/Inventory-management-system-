...
public class SaleManagementGUI extends JPanel {
    ...
    private class AddButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JOptionPane.showMessageDialog(SaleManagementGUI.this, "Sale added successfully!");
            clearFields();
        }
    }
    ...
    private class EditButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (selectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(SaleManagementGUI.this, "Sale updated successfully!");
                clearFields();
            } else {
                JOptionPane.showMessageDialog(SaleManagementGUI.this, "Please select a sale to edit.");
            }
        }
    }
    ...
    private class DeleteButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (selectedRow != -1) {
                ...
                JOptionPane.showMessageDialog(SaleManagementGUI.this, "Sale deleted successfully!");
            } else {
                JOptionPane.showMessageDialog(SaleManagementGUI.this, "Please select a sale to delete.");
            }
        }
    }
    ...
    private class GenerateReportButtonListener implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(SaleManagementGUI.this, "Generate Report button clicked.");
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setContentPane(new SaleManagementGUI());
